...
<a href="<?= base_url('pengajar/dashboard') ?>" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white/10 transition">
    <i class="fas fa-tachometer-alt w-5"></i>
    <span>Dashboard</span>
</a>
<a href="<?= base_url('pengajar/jadwal') ?>" class="sidebar-link active flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white/10 transition">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-4 border-b">
            <h3 class="font-semibold text-gray-800">Jadwal Anda</h3>
        </div>
        <div class="p-4 max-h-[500px] overflow-y-auto">
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 bg-gray-50 rounded-lg">
                    ...
                    <form action="<?= base_url('pengajar/jadwal/status/' . $jadwal['id']) ?>" method="POST">
                        <?= csrf_field() ?>
                        <input type="hidden" name="status" value="selesai">
                        <button type="submit" class="w-full bg-accent hover:bg-accent-hover text-white px-3 py-2 rounded-lg text-sm transition">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: '<?= base_url('pengajar/jadwal/events') ?>',
