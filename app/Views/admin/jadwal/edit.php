...
<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-6">Edit Jadwal</h2>
        ...
        <form action="<?= base_url('admin/jadwal/update/' . $jadwal['id']) ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="pengajar_id" 
                    ...
                    <option value="<?= $p['id'] ?>" <?= $jadwal['pengajar_id'] == $p['id'] ? 'selected' : '' ?>><?= $p['nama'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="time" name="waktu" value="<?= $jadwal['waktu'] ?>" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent" required>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="topik" value="<?= $jadwal['topik'] ?>" 
