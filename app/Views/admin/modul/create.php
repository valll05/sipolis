...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-6">Tambah Modul Baru</h2>
        
        <form action="<?= base_url('admin/modul/store') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <select name="kategori" 
                        ...
                        <option value="sosial" <?= old('kategori') == 'sosial' ? 'selected' : '' ?>>Statistik Sosial</option>
                        <option value="produksi" <?= old('kategori') == 'produksi' ? 'selected' : '' ?>>Statistik Produksi</option>
                        <option value="distribusi" <?= old('kategori') == 'distribusi' ? 'selected' : '' ?>>Statistik Distribusi</option>
                        <option value="neraca" <?= old('kategori') == 'neraca' ? 'selected' : '' ?>>Neraca & Analisis</option>
                    </select>
                </div>
            ...
            <div class="mb-6">
                <label class="block text-gray-700 text-sm font-medium mb-2">File PDF</label>
